...
- Successful downloads upsert `~/.youtube-music-cli/downloads-index.json`; playback prefers local files via `resolveTrackPlayUrl` / `preferLocalPlayback` (default true) in Ink, immersive, CLI, and web
